...
export const copy = {
	en: {
		...
		editorDuePlaceholder: "Pick a date",
		editorDueClear: "Clear date",
		datePresetToday: "Today",
		datePresetTomorrow: "Tomorrow",
		datePresetNextWeek: "Next week",
		datePresetInTwoWeeks: "In 2 weeks",
		datePresetEndOfMonth: "End of month",
		datePresetNextMonth: "Next month",
	...
	he: {
		...
		editorDuePlaceholder: "בחירת תאריך",
		editorDueClear: "ניקוי תאריך",
		datePresetToday: "היום",
		datePresetTomorrow: "מחר",
		datePresetNextWeek: "שבוע הבא",
		datePresetInTwoWeeks: "בעוד שבועיים",
		datePresetEndOfMonth: "סוף החודש",
		datePresetNextMonth: "חודש הבא",
